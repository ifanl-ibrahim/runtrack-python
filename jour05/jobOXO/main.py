...
class TicTacToe:
    ...
    def draw_winner(self):
        if self.winner:
            ...
            label = self.font.render(f'Player "{self.winner}" wins! Press Space to Restart', True, 'white', 'black')
            self.game.screen.blit(label, (WIN_SIZE // 2 - label.get_width() // 2, WIN_SIZE // 2.5))
